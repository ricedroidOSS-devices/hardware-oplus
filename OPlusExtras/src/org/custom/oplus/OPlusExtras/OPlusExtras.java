...
package org.custom.oplus.OPlusExtras;
...
import org.custom.oplus.OPlusExtras.doze.DozeSettingsActivity;
import org.custom.oplus.OPlusExtras.FileUtils;
import org.custom.oplus.OPlusExtras.modeswitch.*;
import org.custom.oplus.OPlusExtras.preferences.*;
import org.custom.oplus.OPlusExtras.R;
import org.custom.oplus.OPlusExtras.services.*;
import org.custom.oplus.OPlusExtras.slider.SliderConstants;
import org.custom.oplus.OPlusExtras.touch.TouchscreenGestureSettings;
...
public class OPlusExtras extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mHBMInfo.setOnPreferenceClickListener(preference -> {
            ...
            Drawable custom = getResources().getDrawable(R.drawable.custom,null);
             int randomColor;
             randomColor = Color.rgb(
             Color.red(rand.nextInt(0xFFFFFF)),
             Color.green(rand.nextInt(0xFFFFFF)),
             Color.blue(rand.nextInt(0xFFFFFF)));
             custom.setTint(randomColor);

            ParticleSystem ps = new ParticleSystem(getActivity(),50,custom,2000);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.custom.oplus.OPlusExtras.services.FPSInfoService.class);
            if (enabled) {
